...
// source: QfProtobufExample.proto

#include "QfProtobufExample.pb.h"
...
static void InitDefaultsscc_info_SearchRequest_QfProtobufExample_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SearchRequest_QfProtobufExample_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_SearchRequest_QfProtobufExample_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_QfProtobufExample_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_QfProtobufExample_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_QfProtobufExample_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_QfProtobufExample_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_QfProtobufExample_2eproto[] =
  "\n\027QfProtobufExample.proto\"L\n\rSearchReque"
  "st\022\r\n\005query\030\001 \001(\t\022\023\n\013page_number\030\002 \001(\005\022\027"
  "\n\017result_per_page\030\003 \001(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_QfProtobufExample_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_QfProtobufExample_2eproto_sccs[1] = {
  &scc_info_SearchRequest_QfProtobufExample_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_QfProtobufExample_2eproto_once;
static bool descriptor_table_QfProtobufExample_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_QfProtobufExample_2eproto = {
  &descriptor_table_QfProtobufExample_2eproto_initialized, descriptor_table_protodef_QfProtobufExample_2eproto, "QfProtobufExample.proto", 111,
  &descriptor_table_QfProtobufExample_2eproto_once, descriptor_table_QfProtobufExample_2eproto_sccs, descriptor_table_QfProtobufExample_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_QfProtobufExample_2eproto::offsets,
  file_level_metadata_QfProtobufExample_2eproto, 1, file_level_enum_descriptors_QfProtobufExample_2eproto, file_level_service_descriptors_QfProtobufExample_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_QfProtobufExample_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_QfProtobufExample_2eproto), true);
...
void SearchRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SearchRequest_QfProtobufExample_2eproto.base);
  query_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void SearchRequest::SerializeWithCachedSizes(
  ...
  if (this->page_number() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(2, this->page_number(), output);
  }

  // int32 result_per_page = 3;
  if (this->result_per_page() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(3, this->result_per_page(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* SearchRequest::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 page_number = 2;
  if (this->page_number() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->page_number(), target);
  }

  // int32 result_per_page = 3;
  if (this->result_per_page() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->result_per_page(), target);
  }
